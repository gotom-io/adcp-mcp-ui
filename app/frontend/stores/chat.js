...
export function useChat(settings) {
  const { authToken, mcpServer } = settings;
  ...
  const getRequestHeaders = () => ({
    ...
    'x-ai-model': settings.aiModel.value,
  ...
  return { promptInput, messages, error, loading, chatContainer, inputArea, scrollToBottom, adjustTextareaHeight, getRequestHeaders, clearHistory, submit, handleKeydown, sessionId };
}
